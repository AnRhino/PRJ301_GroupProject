...
<html>
    ...
    <body>
        ...
        <div class="d-flex justify-content-center align-content-center mt-5">
            <div class="row-1 bg-light w-50 shadow">
                <div>
                ...
                <p class="ms-4 mb-3" id="profile">
                    ...
                    <!-- Modal button -->  
                    <a href="${pageContext.request.contextPath}/user-profile?view=editPassword" type="button" data-bs-toggle="modal" data-bs-target="#editPasswordModal"><i class="bi bi-pencil-square"></i></a>
                </p>
